...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(22)
		::openfl::_v2::Lib_obj::setPackage(HX_CSTRING("Marco"),HX_CSTRING("pongame"),HX_CSTRING("com.pd.pongame"),HX_CSTRING("1.0.0"));
		...
		HX_STACK_LINE(35)
		::openfl::_v2::Lib_obj::create( Dynamic(new _Function_1_1()),(int)0,(int)0,(int)60,(int)3355443,(int((int((int((int((int((int((int((int((int((int(::openfl::_v2::Lib_obj::HARDWARE) | int(::openfl::_v2::Lib_obj::ALLOW_SHADERS))) | int(::openfl::_v2::Lib_obj::REQUIRE_SHADERS))) | int((int)0))) | int((int)0))) | int(::openfl::_v2::Lib_obj::RESIZABLE))) | int((int)0))) | int((int)0))) | int(::openfl::_v2::Lib_obj::FULLSCREEN))) | int((int)0))) | int((int)0)),HX_CSTRING("pongame"),null(),null());
	}
return null();
}
