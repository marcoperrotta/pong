...
Void Main_obj::init( ){
{
		...
		HX_STACK_LINE(176)
		::openfl::_v2::text::TextFormat scoreFormat = ::openfl::_v2::text::TextFormat_obj::__new(this->font->fontName,(Float(this->alt) / Float((int)20)),(int)16711680,null(),null(),null(),null(),null(),null(),null(),null(),null(),null());		HX_STACK_VAR(scoreFormat,"scoreFormat");
		HX_STACK_LINE(177)
