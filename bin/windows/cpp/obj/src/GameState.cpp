...
::GameState GameState_obj::Inizio;
...
{
	if (inName==HX_CSTRING("Inizio")) return 2;
...
{
	if (inName==HX_CSTRING("Inizio")) return 0;
	if (inName==HX_CSTRING("Paused")) return 0;
...
{
	if (inName==HX_CSTRING("Inizio")) return Inizio;
...
static void sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(GameState_obj::Inizio,"Inizio");
...
static void sVisitStatic(HX_VISIT_PARAMS) {
	...
	HX_VISIT_MEMBER_NAME(GameState_obj::Inizio,"Inizio");
...
{
hx::Static(Inizio) = hx::CreateEnum< GameState_obj >(HX_CSTRING("Inizio"),2);
